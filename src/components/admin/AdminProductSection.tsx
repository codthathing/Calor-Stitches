...
import AdminMainPriceDiv from "./AdminMainPriceDiv";
...
const AdminProductSection = () => {
  ...
  const [priceArray, setPriceArray] = useState([
    { id: 0, priceTitle: "Normal price", priceDiv: <AdminMainPriceDiv />, showPriceDiv: true },
    { id: 1, priceTitle: "Average price", priceDiv: <AdminAveragePriceDiv />, showPriceDiv: false },
  ]);
