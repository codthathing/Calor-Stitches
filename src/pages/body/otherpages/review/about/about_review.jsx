...
const AboutReview = () => {
  return (
    <div className="productAboutDivs">
      ...
      <main className="product-about-main">
        <p className="about-main-text">Add A Review</p>
        ...
        <div id="about-rating-div">
          ...
          <form id="about-rating-form">
            <div id="rating-input-div">
              <textarea type="text" placeholder="Your Review *" className="rating-input" />
            ...
            <button type="button" id="rating-submit-button">SUBMIT</button>
          </form>
        </div>
      </main>
    </div>
