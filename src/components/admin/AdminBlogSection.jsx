  ...
  return (
    <div className="admin-div" id="admin-blog">
      ...
      <form className="admin-post-form">
        <AdminGroupInput addOne={true} textClass={"admin-product-text"} adminArray={blogImage} setAdminArray={setBlogImage} defaultText={"Blog image"} placeholder={"Add image"} />
        <AdminGroupInput addText={true} style={true} defaultText={"Blog categories"} placeholder={"Add category"} adminArray={blogCategory} setAdminArray={setBlogCategory} />
        ...
        <AdminGroupInput addOne={true} textClass={"admin-product-text"} adminArray={authorImage} setAdminArray={setAuthorImage} defaultText={"Author image"} placeholder={"Add image"} />
        <div className="admin-form-div">
