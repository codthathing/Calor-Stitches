...
const WishlistStockAlert = ({mainClass, textClass, barClass, showStock = true, stockAmt, showStockBar, stockZero = "Item presently not in stock", stockNine = `Only ${stockAmt} units of this item are left in stock`, stockMore = "In stock, ready to be shipped" }) => {
...
export default WishlistStockAlert;